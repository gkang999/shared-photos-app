  ...
  return (
    <div className="About">
        ...
        <div id="aboutMe">
          ...
          sent to a Maven-built Spring Web Application hosted on Heroku. The Spring app sends queries to a MySQL Database I'm hosting. 
          Using this information, it can then make requests to a media service API; that API stores and serves up 
